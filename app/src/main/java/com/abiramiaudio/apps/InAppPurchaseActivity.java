...
import com.abiramiaudio.apps.util.IabBroadcastReceiver;
import com.abiramiaudio.apps.util.IabHelper;
import com.abiramiaudio.apps.util.IabResult;
import com.abiramiaudio.apps.util.Inventory;
import com.abiramiaudio.apps.util.Purchase;


import java.util.ArrayList;
import java.util.List;

import static com.abiramiaudio.apps.Constants.SKU_DELAROY_MONTHLY;
import static com.abiramiaudio.apps.Constants.SKU_DELAROY_SIXMONTH;
import static com.abiramiaudio.apps.Constants.SKU_DELAROY_THREEMONTH;
import static com.abiramiaudio.apps.Constants.SKU_DELAROY_YEARLY;
import static com.abiramiaudio.apps.Constants.base64EncodedPublicKey;
...
public class InAppPurchaseActivity extends AppCompatActivity implements IabBroadcastReceiver.IabBroadcastListener,
    ...
    IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
        @Override
        public void onIabPurchaseFinished(IabResult result, com.abiramiaudio.apps.util.Purchase purchase) {
    ...
    IabHelper.OnConsumeFinishedListener mConsumeFinishedListener = new IabHelper.OnConsumeFinishedListener() {
        @Override
        public void onConsumeFinished(com.abiramiaudio.apps.util.Purchase purchase, IabResult result) {
